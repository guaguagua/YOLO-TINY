...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        float thresh = find_float_arg(argc, argv, "-thresh", .5);   printf("wsy***** thresh:%f \n",thresh);
        char *filename = (argc > 4) ? argv[4]: 0;                   printf("wsy***** filename:%s \n",filename);
        char *outfile = find_char_arg(argc, argv, "-out", 0);       printf("wsy***** outfile:%s \n",outfile);
        int fullscreen = find_arg(argc, argv, "-fullscreen");       printf("wsy***** fullscreen:%d \n",fullscreen);
